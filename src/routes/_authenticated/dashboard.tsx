                ...
                <div className="flex flex-wrap items-start justify-between gap-3">
                  <div>
                    ...
                    <div className="mt-2 flex flex-wrap gap-1.5">
                      ...
                      {candidate.appointment_status && <span className="rounded-full bg-primary/10 px-2 py-0.5 text-xs font-medium text-primary">Interview scheduled</span>}
                      {candidate.preparation_email_status && <span className={cn("rounded-full px-2 py-0.5 text-xs font-medium", candidate.preparation_email_status === "failed" ? "bg-destructive/10 text-destructive" : "bg-success/15 text-success")}>Preparation email {candidate.preparation_email_status}</span>}
                    </div>
                  </div>
